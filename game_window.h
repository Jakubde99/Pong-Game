//
// Created by jakub on 07.11.2019.
//

#ifndef PROJEKT_APLIKACJE_GAME_WINDOW_H
#define PROJEKT_APLIKACJE_GAME_WINDOW_H
#include"Klasa1.h"
void game ()
{
...
//switch case
            ...
            for(int s =-1 ;s>900;s++){
                ...
                //player1.setPosition( p1.getX(), p1.getY()  );
                //player1.setPosition(p2.getX(), p2.getY()  );
                //ball.setPosition(c.getX(),c.getY());
                //cout<<wynik1<<"  WYNIK  "<<wynik2<<endl;
                //cout<<c.getX()<<"     "<<c.getY()<<endl;
                //cout<<ball.getPosition().x<<" pilka "<<ball.getPosition().y<<endl<<endl;

                //cout<<player1.getPosition().x<<" gr2 "<<player2.getPosition().y<<endl;
                //cout<<p1.getX()<<" gracz2 "<<p2.getY()<<endl<<endl;
                //cout<<player0.getPosition().x<<" gr1 "<<player1.getPosition().y<<endl;
                //cout<<p0.getX()<<" gracz1 "<<p1.getY()<<endl<<endl;
...
#endif //PROJEKT_APLIKACJE_GAME_WINDOW_H
